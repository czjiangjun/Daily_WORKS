...
\title{{\rm VASP}软件的核心:~{\rm PAW}方法与迭代优化算法}
%\author[a]{Author A}									     %
\author[ ]{姜~骏}   %
%\author[a]{Author B}									     %
...
\lfoot{\hei{地址:~~北京市海淀区丰贤中路7号北科产业3号楼 ~~~~ 邮编: ~~~~ 100094\\电话:~~010-59341997/98 ~~~~~ 传真:~~0101-59341888 ~~~~~ 网址:~~wwww.bcc.ac.cn}}  %页脚
...
\begin{minipage}[b]{0.20\textwidth}
	\vspace{17pt}
\includegraphics[height=1.1in]{Person_Photo.JPG}
\end{minipage}
\vskip 30pt
%3.~个人研究内容与兴趣
