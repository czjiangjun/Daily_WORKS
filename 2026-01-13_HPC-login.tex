...
%	2026-03-327
%	{\fontsize{9.8pt}{6.2pt}\selectfont{bcc\_jiangj}}  &{\fontsize{9.8pt}{6.2pt}\selectfont{BCCbcc!@\#456}}  &{\fontsize{9.8pt}{6.2pt}\selectfont{bcc\_jiangj}}  &{\fontsize{9.8pt}{6.2pt}\selectfont{@rM6PXCg1IHrTo}} & \\
	{\fontsize{9.8pt}{6.2pt}\selectfont{bcc\_jiangj}}  &{\fontsize{9.8pt}{6.2pt}\selectfont{BCC317123\$\%\^{}}}  &{\fontsize{9.8pt}{6.2pt}\selectfont{bcc\_jiangj}}  &{\fontsize{9.8pt}{6.2pt}\selectfont{@rM6PXCg1IHrTo}} & \\
...
%	{\fontsize{9.8pt}{6.2pt}\selectfont{gzsc\_jaj}}  &{\fontsize{9.8pt}{6.2pt}\selectfont{BCCbcc@317123}}  &{\fontsize{9.8pt}{6.2pt}\selectfont{nsgm\_jiangj}}  &{\fontsize{9.8pt}{6.2pt}\selectfont{N202507140025}} & \\
	{\fontsize{9.8pt}{6.2pt}\selectfont{gzsc\_jaj}}  &{\fontsize{9.8pt}{6.2pt}\selectfont{BCCbcc123\$\%\textasciicircum}} %可以用\^{} 替换\textasciicircum
	&{\fontsize{9.8pt}{6.2pt}\selectfont{nsgm\_jiangj}}  &{\fontsize{9.8pt}{6.2pt}\selectfont{N202507140025}} & \\
	\bottomrule[1.8pt]     %%绘制三线表底部线,粗细设置
\end{tabular*}
%\rule{\temptablewidth}{1.8pt}
%\end{center}
...
\begin{tabular*}{\temptablewidth}{@{\extracolsep{\fill}}c@{\extracolsep{\fill}}c@{\extracolsep{\fill}}c}
	\toprule[2pt]        %% 绘制三线表顶端线,粗细设置
	\multicolumn{2}{c}{\fontsize{10.2pt}{6.2pt}\selectfont{服务器登录信息}} & \multirow{2}{*}{\fontsize{10.2pt}{6.2pt}\selectfont{备注}}\\
	账号 & 密码 & \\
%-------------------------------------------------------------------------------------------------------------------------
%&Peak (eV)  & {$\vec k$}-point            &Band{$_v$} to Band{$_c$}  &Transition Orbital
%Components\footnote{波函数主要成分后的括号中，$5s$、$5p$和$5p$、$4f$、$5d$分别指碲和铕的原子轨道。} &Gap (eV)   \\ \hline
...
%-------------------------------------------------------------------------------------------------------------------------
	\midrule[1pt]        %% 绘制三线表中间线,粗细设置
	\multicolumn{2}{c}{\fontsize{10.2pt}{6.2pt}\selectfont{\url{https://desktop.yeesuan.com/desktop/}}} &手机号、验证码~登录\\
%	2026-01-13
%	{\fontsize{9.8pt}{6.2pt}\selectfont{bcc\_jiangj}}  &{\fontsize{9.8pt}{6.2pt}\selectfont{BCCbcc123\$\%\^{}}}  &{\fontsize{9.8pt}{6.2pt}\selectfont{bcc\_jiangj}}  &{\fontsize{9.8pt}{6.2pt}\selectfont{@rM6PXCg1IHrTo}} & \\
%	2026-03-327
%	{\fontsize{9.8pt}{6.2pt}\selectfont{bcc\_jiangj}}  &{\fontsize{9.8pt}{6.2pt}\selectfont{BCCbcc!@\#456}}  &{\fontsize{9.8pt}{6.2pt}\selectfont{bcc\_jiangj}}  &{\fontsize{9.8pt}{6.2pt}\selectfont{@rM6PXCg1IHrTo}} & \\
...
%-------------------------------------------------------------------------------------------------------------------------
	\midrule[1pt]        %% 绘制三线表中间线,粗细设置
	\multicolumn{2}{c}{\fontsize{10.2pt}{6.2pt}\selectfont{\url{https://123.59.0.91:22333}}} &\\
%	{\fontsize{9.8pt}{6.2pt}\selectfont{root}}  &{\fontsize{9.8pt}{6.2pt}\selectfont{Welcome123\$\%\^{}}} & \\ %CentOS7操作系统
%	{\fontsize{9.8pt}{6.2pt}\selectfont{BCC317}}  &{\fontsize{9.8pt}{6.2pt}\selectfont{BCC317!@\#\$}} & \\ %CentOS7操作系统
	{\fontsize{9.8pt}{6.2pt}\selectfont{user}}  &{\fontsize{9.8pt}{6.2pt}\selectfont{Welcome123\$\%\^{}}} & \\ %CentOS7操作系统
	\bottomrule[1.8pt]     %%绘制三线表底部线,粗细设置
\end{tabular*}
%\rule{\temptablewidth}{1.8pt}
%\end{center}
...
\begin{tabular*}{\temptablewidth}{@{\extracolsep{\fill}}c@{\extracolsep{\fill}}c@{\extracolsep{\fill}}c@{\extracolsep{\fill}}c}
	\toprule[2pt]        %% 绘制三线表顶端线,粗细设置
	\multirow{2}{*}{\fontsize{10.2pt}{6.2pt}\selectfont{模型名称}}  & \multicolumn{3}{c}{\fontsize{10.2pt}{6.2pt}\selectfont{\textrm{API}登录信息}} \\
	 &账号  &密码 &备注\\
%-------------------------------------------------------------------------------------------------------------------------
%&Peak (eV)  & {$\vec k$}-point            &Band{$_v$} to Band{$_c$}  &Transition Orbital
%Components\footnote{波函数主要成分后的括号中，$5s$、$5p$和$5p$、$4f$、$5d$分别指碲和铕的原子轨道。} &Gap (eV)   \\ \hline
...
%-------------------------------------------------------------------------------------------------------------------------
	\midrule[1pt]        %% 绘制三线表中间线,粗细设置
%	{\fontsize{9.8pt}{6.2pt}\selectfont{\textrm{Deepseek}}} &{\fontsize{9.8pt}{6.2pt}\selectfont{\textrm{Hexaborides}}} &{\fontsize{9.8pt}{6.2pt}\selectfont{\textrm{sk-f1a87bbcc89b48eaaf89fd288d9cf1fd}}} &\\
%	{\fontsize{9.8pt}{6.2pt}\selectfont{\textrm{Deepseek}}} &{\fontsize{9.8pt}{6.2pt}\selectfont{\textrm{Hexaborides}}} &{\fontsize{9.8pt}{6.2pt}\selectfont{\textrm{sk-fc67cbea79764a398f1ce44354925179}}} &\\
	{\fontsize{9.8pt}{6.2pt}\selectfont{\textrm{Deepseek}}} &{\fontsize{9.8pt}{6.2pt}\selectfont{\textrm{Hexaborides}}} &{\fontsize{9.8pt}{6.2pt}\selectfont{\textrm{sk-765cd282ba71499a8109da0298897d7b}}} &\\
	\bottomrule[1.8pt]     %%绘制三线表底部线,粗细设置
\end{tabular*}
%\rule{\temptablewidth}{1.8pt}
%\end{center}
\end{minipage}\\
\textcolor{red}{注意针对\textrm{Claude-Code}，在环境变量中务必设置\\
\textrm{''CLAUDE\_CODE\_ATTRIBUTION\_HEADER''}的值为\textrm{0}\\
\textrm{``MAX\_CONSECUTIVE\_AUTO\_COMPACT\_FAILURES''}的值为\textrm{3}}
\end{table}
