...
%--------%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%--------%
%\bibliography 和 \bibliographystyle 要使用相对路径 (!!! --- 相对路径是相对于根文件的位置，不是当前文件 --- !!!)
\bibliography{/home/jun-jiang/Documents/Reference/Myref}                         %% $PATH用于脚本指定图片路径
%\bibliography{/home/jun-jiang/Documents/Reference/Myref}                         %
%%\bibliography{../../ref/Myref, ../ref/Myref_from_2013}        %% 多个参考文献 .bib
\bibliographystyle{/home/jun-jiang/Documents/Reference/mybib}                   %%  $PATH用于脚本指定图片路径
%\bibliographystyle{/home/jun-jiang/Documents/Reference/mybib}                   %%   接近ieeert样式
