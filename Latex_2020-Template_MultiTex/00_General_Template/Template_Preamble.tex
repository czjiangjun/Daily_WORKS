...
\usepackage{soul}                                          % 引入soul宏包，支持文本高亮
\usepackage[normalem]{ulem}
\usepackage{cancel}				% delete line \sout, \xout, \cancel, \bcancel, \xcancel, \cancelto
\sethlcolor{yellow}                                        % 设置高亮颜色为黄色
%\textcolor[rgb]{0.25, 0.5, 0.75}{自定义颜色1}
%\textcolor[rgb]{0.75, 0.5, 0.25}{自定义颜色2}
%\color{color}:~设置主颜色;
%\textcolor{color}{text}:~设置文字颜色;
%\pagecolor{color}:~设置页面背景色;
%\nopagecolor:~去除背景颜色;
%\colorbox{color}{text}:~设置文字的背景色；
%\fcolorbox{framecolor}{backgroundcolor}{text}：给文字绘制指定框颜色和背景色的矩形框。

%\definecolor{red}{rgb}{1,0,0} % rgb模型，颜色名：red，具体颜色定义：red:1, green:0, blue:0
%\definecolor{red}{rgb/cmyk}{1,0,0/0,1,1,0} % 用在不同场合会自动转换模型
%\definecolor{red}{hsb}{0,1,1}
%\definecolor{red}{hsb:rgb/cmyk}{1,0,0/0,1,1,0} % 将rgb和cmyk的颜色转为用hsb来存储
%\usepackage{hyperref} 
\usepackage{graphicx}
...
\usepackage{fancyvrb}			% 导入增强型verbatim包
