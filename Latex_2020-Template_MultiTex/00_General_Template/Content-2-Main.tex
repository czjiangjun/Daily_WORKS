...
%\begin{tabular*} {\temptablewidth}{|@{\extracolsep{\fill}}m{2.1cm}<\centering|@{\extracolsep{\fill}}m{2.1cm}<\centering|@{\extracolsep{\fill}}m{2.1cm}<\centering|}%%% \centering 表示居中  \raggerdright 表示左对齐
...
%%%%%%%%%%%%%%%%%%%%%%%  \chemfig 绘制有机分子的设置  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\setchemfig{atom sep=2em,bond style={line width=1pt, red, dash pattern=on 2pt off 2pt}}  %% 设置分子式中的原子距离、键长和表示形式
%\chemname{\chemfig{H-C(-[2]H)-C(=[1]O)-O>H}}{\textrm{Acetaldehyde}}   %% 添加分子式描述(如名称)

%% single-bond          \chemfig{O-H}
%% double-bond          \chemfig{O=H}
%% triple-bond          \chemfig{O~H}
...
%-----%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-----插-入-本-地-文-件-链-接-----%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%------%
%\href{run:./本地文件绝对/相对路径}{展示链接标记:~文件名/文字符号均可}
%--------------------------------------%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%----------------------------------%
