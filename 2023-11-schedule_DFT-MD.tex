...
&09:30-11:30 & \makecell[c]{量子力学基础\\ \textrm{Hartree-Fock}与\textrm{DFT}\\%&&ABINIT输入文件中的参数设置\\
\textrm{Kohn-Sham}方程与交换-相关泛函}\\
\cline{2-3}
\raisebox{6ex}[0pt][0pt]{\makecell[c]{~第一天~}} &13:30-16:30& \makecell[l]{固体能带理论\\固体能带计算方法:\\(1)赝势\textrm{(PP)}方法\\(2)投影子缀加波\textrm{(PAW)}方法}\\
\hline
