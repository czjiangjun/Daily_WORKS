...
日期　&时间　&\;\;内容\\\hline
第一天&9:30-11:30 & 量子力学基础\\
&&\textrm{H-F}与\textrm{DFT}\\
&&\textrm{K-S}方程与交换-相关泛函\\
%&&ABINIT输入文件中的参数设置\\
\cline{2-3}
&13:30-17:00& 固体能带理论\\
&&固体能带计算方法:\\
...
\hline
第二天&9:00-11:30 &~\textrm{PAW}方法与\textrm{VASP}软件\\
&&~\textrm{VASP}的计算特色\\
&&(3)\textrm{LAPW}与\textrm{LMTO}方法\\
%&&金属(导体)与非金属(半导体、绝缘体)的能带结构\\
\cline{2-3}
&13:30-17:00&$\vec k$空间布点与积分方法:\\
&&~(1)$\vec k$-空间布点\\
&&~(2)$\vec k$-空间积分:~特殊点方案\\
&&~(3)$\vec k$-空间积分:~四面体方案 \\
\hline
