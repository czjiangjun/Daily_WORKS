...
利用衔接软件，可以将化合物、化学反应和\textrm{DFT}衔接在一起\upcite{CCE137-106813_2020}。因为\textrm{OntoKin}中可能涉及到成千上万的化学物种和化学反应，所以这样的衔接软件是非常必要的\upcite{ACSO5-18342_2020}。衔接软件可以追索每个反应。图\ref{Fig:Automated-linking-between-OntoSpecies-Kin-CompChem}给出火箭推进的氢燃料燃烧反应涉及的10种化学物种和40个基元反应，其中有一个是\ch{H2O2}~+\ch{*OH}~$\rightleftharpoons$~\ch{H2O}~+\ch{*OOH}。
\begin{figure}[h!]
\centering
