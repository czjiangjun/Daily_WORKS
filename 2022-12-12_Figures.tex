...
%
  ...
  \node [box-rect, below=0.8 of Canonical-ensemble, fill=white, text width=15.0em, minimum height=0.5em, very thin] (Small-Strain) {\fontsize{8.5pt}{5.5pt}\selectfont{构建材料生长模块尺寸与范围}};
...
%
  ...
  \node [box-trape, below=0.8 of Young-Modulus, fill=red!50, text width=9.0em, minimum height=0.5em] (Output-Mechanical-Properties) {\fontsize{9.5pt}{5.5pt}\selectfont{输出达到平衡态时\\描述力学性质数据}};
%
%%%%%%% ------------ 定义 虚线方框转角 -----------------  %%%%%%
\path
...
\path [arrow, black,thick] (Continue-next-time-step.south) -- (Output-equilibrated-system.north);
%
...
\path [arrow, black,thick] (Continue-next-stress-step.south) -- (Young-Modulus.north);
\path [arrow, black,thick] (Young-Modulus.south) -- (Output-Mechanical-Properties.north);
%
\path [arrow, black,thick] (Continue-next-time-step.west) -| (Continue-1) |- (Calculation-Force.west);
\path [arrow, black,thick] (Continue-next-time-step.north)++(0.0em, 1.2em) -| (Return) -| (Canonical-ensemble.north);
\path [arrow, black,thick] (Continue-next-stress-step.east) -| (Continue-2) |- (Small-Strain.east);
%
%%%%%%% ------------ 绘制 虚线 -----------------  %%%%%%
