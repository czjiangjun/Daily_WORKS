...
\tikzstyle{straightline} = [line width = 1pt,-]
		...
		\node [box-rect, right=1.0 of nr-real-space, fill=purple!50, text width=2.5em, draw=cyan, minimum height=0.5em, thick] (FFT-1) {\textcolor{white}{\textbf{FFT}}};
		\node [box-rect, right=4.0 of FFT-1, fill=violet!50, text width=13.0em, draw=NavyBlue, minimum height=0.5em, thick] (psi-G1-reciprocal-space) {$\tilde \Psi(\vec G_1)$\textcolor{white}{倒空间(粗网格)表示}};
		\node [box-rect, below=1.0 of nr-real-space, fill=violet!50, text width=13.0em, draw=NavyBlue, minimum height=0.5em, thick] (nG1-reciprocal-space) {$\tilde n(\vec G_1)$\textcolor{white}{倒空间(粗网格)表示}};
		\node [box-rect, right=1.0 of nG1-reciprocal-space, fill=purple!50, text width=2.5em, draw=cyan, minimum height=0.5em, thick] (FFT-2) {\textcolor{white}{\textbf{FFT}}};
		\node [box-rect, right=1.0 of FFT-2, fill=NavyBlue!50, text width=13.0em, draw=cyan, minimum height=0.5em, thick] (nr1-real-space) {$\hat n(\vec r)$正空间(密网格)表示};
		\node [box-rect, below=1.0 of nG1-reciprocal-space, fill=RedOrange!50, text width=13.0em, draw=NavyBlue, minimum height=0.5em, thick] (nG2-reciprocal-space) {$\tilde n(\vec G_2)$\textcolor{white}{倒空间(密网格)表示}};
		\node [box-rect, right=1.0 of nG2-reciprocal-space, fill=purple!50, text width=2.5em, draw=cyan, minimum height=0.5em, thick] (FFT-3) {\textcolor{white}{\textbf{FFT}}};
		\node [box-rect, right=1.0 of FFT-3, fill=RedOrange!50, text width=13.0em, draw=NavyBlue, minimum height=0.5em, thick] (nG22-reciprocal-space) {$\hat n(\vec G_2)$\textcolor{white}{倒空间(密网格)表示}};
		\node [box-rect, below=1.0 of nG2-reciprocal-space, fill=NavyBlue!50, text width=13.0em, draw=cyan, minimum height=0.5em, thick] (nr12-real-space) {$\tilde n(\vec r)$正空间(密网格)表示};

		\node [box-rect, below=1.8 of nr12-real-space, fill=RedOrange!50, text width=13.5em, draw=NavyBlue, minimum height=0.5em, thick] (VHG2-reciprocal-space) {$V_{\mathrm{H}}(\vec G_2)$\textcolor{white}{倒空间(密网格)表示}};
		\node [box-rect, right=1.0 of VHG2-reciprocal-space, fill=purple!50, text width=2.5em, draw=cyan, minimum height=0.5em, thick] (FFT-4) {\textcolor{white}{\textbf{FFT}}};
		...
		\node [box-rect, below=1.0 of VHG2-reciprocal-space, fill=NavyBlue!50, text width=13.0em, draw=cyan, minimum height=0.5em, thick] (Vr1-real-space) {$V_{\mathrm{H}}(\vec r)$正空间(密网格)表示};
		...
		\node [box-rect, below=2.5 of FFT-4, fill=purple!50, text width=2.5em, draw=cyan, minimum height=0.5em, thick] (FFT-5) {\textcolor{white}{\textbf{FFT}}};
		\node [box-rect, right=1.0 of FFT-5, fill=violet!50, text width=13.8em, draw=NavyBlue, minimum height=0.5em, thick] (VHZc-reciprocal-space) {$V_{\mathrm{H}}(\tilde n_{\mathrm{Zc}})$\textcolor{white}{倒空间(密网格)表示}};

	\node [box-rect, below=1.0 of FFT-5, fill=RedOrange!50, text width=16.8em, draw=NavyBlue, minimum height=0.5em, thick] (VHxcG2-reciprocal-space) {$V_{\mathrm{H}}(\vec G_2)$,$V_{\mathrm{xc}}(\vec G_2)$\textcolor{white}{倒空间(密网格)表示}};
	\node [box-rect, below=1.0 of VHxcG2-reciprocal-space, fill=violet!50, text width=16.8em, draw=NavyBlue, minimum height=0.5em, thick] (VHxcG1-reciprocal-space) {$V_{\mathrm{H}}(\vec G_1)$,$V_{\mathrm{xc}}(\vec G_1)$\textcolor{white}{倒空间(粗网格)表示}};
