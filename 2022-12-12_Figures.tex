...
\begin{figure}[!h]
	\centering
	\begin{tikzpicture}[
    box-rect/.style={rectangle,draw,fill=green!40,node distance=1cm,text width=15em,text centered,rounded corners,minimum height=2em,thick},
    straightline/.style = {line width = 2pt,-},
    arrow/.style={draw,-latex', line width = 2pt},
		]
		\node [box-rect, fill=green!40, text width=2.0em, minimum height=1.5em, yshift=-3.5em, very thin] (Melody) {\fontsize{8.5pt}{2.5pt}\selectfont{唱腔}};
...
;
		...
		\draw [solid, very thick](-8, -3.5) -- (-8, -3.9);
		\draw [solid, very thick](8, -3.5) -- (8, -3.9);
