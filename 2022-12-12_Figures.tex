...
\begin{tikzpicture}[
  ...
  \node [box-rect, below=0.5 of Application, fill=gray!30, text width=12.5em, minimum height=1.5em] (GPUMD-Mechanism) {\fontsize{7.5pt}{2.5pt}\selectfont{\textrm{GPUMD}的基本力学性质计算}};
  \node [box-rect, below=3.3 of Mechanism-Parameter, fill=teal!30, text width=6.5em, minimum height=1.5em] (Atom-Settlement) {\fontsize{7.5pt}{2.5pt}\selectfont{原子沉降过程的\textrm{GPUMD}模拟}};
  \node [box-rect, right=4.1 of Atom-Settlement, fill=violet!30, text width=6.5em, minimum height=1.5em] (Material-Growth) {\fontsize{7.5pt}{2.5pt}\selectfont{材料生长过程的\textrm{GPUMD}模拟}};
  \node [box-rect, below=3.5 of Application, fill=lime!70, text width=6.5em, minimum height=1.5em] (Result-Analysis) {\fontsize{7.5pt}{5.5pt}\selectfont{计算结果可视化分析}};
...
\path [arrow, dotted,  draw=black, thick](Atom-Settlement.east) -- (Material-Growth.west);
\path [arrow, dash dot dot, draw=black, thick](GPUMD-Mechanism.south) -- (Result-Analysis.north);
