...
%
  ...
  \node [box-rect, below=0.5 of Atom-deposition, fill=blue!30, text width=15.0em, minimum height=0.5em] (Atom-Stress) {\fontsize{9.5pt}{5.5pt}\selectfont{计算安放的每个\\原子的受力和应力}};
  \node [box-rect, below=1.0 of Atom-Stress, text width=15.0em, minimum height=0.5em] (Optimization) {\fontsize{9.5pt}{5.5pt}\selectfont{将模拟体系在应力作用方向充分弛豫，能量最小化}};
%
  ...
  \node [box-diam, below=0.8 of NPT-Canonical-ensemble, fill=purple!30, text width=10.0em, minimum height=0.5em] (Calculate-Stress) {\fontsize{9.5pt}{5.5pt}\selectfont{评估增加沉降原子后体系是否稳定\\将每个原子\\在应力方向上按步长移动}};
...
\path
  ...
  (NPT-Canonical-ensemble.west) ++(-1.5em, 0.0em) coordinate (Continue-2)
  (NPT-Canonical-ensemble.east) ++(1.5em, 0.0em) coordinate (Continue-3)
  ...
  (Atom-Stress.south east) ++(0.5em, -0.5em) coordinate (Corner-Atom-2) 

  (Range-Material-grow.north west) ++(-2.5em, 0.5em) coordinate (Corner-Material-1) 
  (Continue-next-stress-step.south east) ++(5.0em, -3.3em) coordinate (Corner-Material-2) 
  ;
%
...
\draw [black, thick] (Continue-next-stress-step.west) -| node[midway,below=0.05,outer sep=0pt, xshift=-0.6em, yshift=12.0em ](TextNode3){\fontsize{8.0pt}{4.5pt}\selectfont{\textbf{\textcolor{black}{否}}}} (Continue-2) |- (Corner-1) ;
\draw [black, thick] (Calculate-Stress.east) -| node[midway,below=0.05,outer sep=0pt, xshift=-0.6em, yshift=7.0em ](TextNode3){\fontsize{8.0pt}{4.5pt}\selectfont{\textbf{\textcolor{black}{否}}}} (Continue-3) |- (Corner-2);
