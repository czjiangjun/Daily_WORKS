...
进入21世纪，欧洲、日本、美国等发达国家先后启动了以多尺度模拟、研发和科学设计为手段，提升材料设计成功率，缩短材料开发周期为目的的多种类型的国家级科研专项，其中以美国的“材料基因组计划(Materials Genome Initiative，MGI)”最为著名。该计划的根本目的是通过增效集成各个尺度的材料模拟工具、高效实验手段和数据库，把材料研发从传统经验式提升到科学设计，从而大大加快材料研发速度。\upcite{CNature36-89_2014}我国也于2016年起启动国家重点研发计划“材料基因工程关键技术与支撑平台”。变革材料计算的研发模式，%计算流程设计与衔接不同尺度的计算过程，降低人机交互频次，优化，实现材料计算流程的自动化与跨尺度物性模拟，
...
\begin{figure}[h!]
\centering
%\includegraphics[height=3.1in,width=4.3in,viewport=0 0 800 650,clip]{Figures/Gray-MP_data_flow.png}%}
...
%\includegraphics[height=2.4in,width=3.4in,viewport=0 0 670 530,clip]{Figures/Gray-MP_comp_infrastructure.png}%}
...
%\includegraphics[height=2.4in]{Figures/Gray-ASE_Python_lib.png}%}
...
%\includegraphics[height=2.4in,width=3.4in,viewport=0 0 670 530,clip]{MP_comp_infrastructure.png}%}
%\includegraphics[height=2.4in,width=3.4in,viewport=0 0 670 420,clip]{QMIP_shame.png}%}
%\includegraphics[height=2.4in]{Figures/Gray-Matcloud.jpg}%}
...
\centering
\hskip -35pt
%\includegraphics[height=6.00in]{Figures/Gray-MP_comp_BCC.png}
...
\centering
\vskip -2pt
%\includegraphics[height=2.25in]{Figures/Gray-CH4_complex_machine.png}
...
\subsection{$\vec k\cdot\vec p$方法加速复杂体系的第一原理计算}
...
\begin{figure}[h!]
\centering
%\includegraphics[height=1.85in,width=5.85in,viewport=0 0 1500 475,clip]{Figures/Gray-Knowledge-based_system.png}
...
\begin{figure}[h!]
\centering
%\includegraphics[height=4.90in,width=5.85in,viewport=0 0 950 790,clip]{Figures/Gray-Mapping-the-relationship-between-molecule-and-synthon.png}
...
\begin{figure}[h!]
\centering
%\includegraphics[height=3.20in,width=4.35in,viewport=0 0 990 750,clip]{Figures/Gray-Key_OntoSpecies-and-external_concepts.png}
...
%\vspace*{-0.05in}
\centering
%\includegraphics[height=4.18in,width=3.92in,viewport=0 0 96 113,clip]{Figures/Gray-KG_Chem-Frame.png}
\includegraphics[height=4.18in,width=3.92in,viewport=0 0 96 113,clip]{Figures/KG_Chem-Frame.png}
\caption{知识图谱的数据传输与知识形成框架。}%(与文献\cite{EPJB33-47_2003}图1对比)
\label{KG_Chem-Frame}
\end{figure} 
...
自然语言处理主要以微服务的方式为用户提供各种应用服务，包括实体识别、实体查询、关系查询、碳化学知识概览等服务。外部应用的服务主要包括碳化学知识图谱展现等业务系统，需要通过数据中台调用知识库的知识接口服务。接口封装集成支撑层技术服务逻辑，形成统一标准的知识接口和数据接口向上为系统应用提供服务。
...
\begin{figure}[h!]
	\vskip -10pt
\centering
%\includegraphics[height=2.40in,width=4.85in,viewport=0 0 160 95,clip]{Figures/Gray-KG_Chem-entity_search.png}
\includegraphics[height=2.40in,width=4.85in,viewport=0 0 160 95,clip]{Figures/KG_Chem-entity_search.png}
...
\begin{figure}[h!]
\centering
%\includegraphics[height=2.40in,width=4.85in,viewport=0 0 145 80,clip]{Figures/Gray-KG_Chem-entity.png}
...
\begin{figure}[h!]
\centering
%\includegraphics[height=2.40in,width=4.85in,viewport=0 0 145 80,clip]{Figures/Gray-KG_Chem-entity-check.png}
...
\begin{figure}[h!]
\centering
%\includegraphics[height=2.40in,width=4.85in,viewport=0 0 145 80,clip]{Figures/Gray-KG_Chem-entity-relation.png}
...
\begin{figure}[h!]
\centering
%\includegraphics[height=2.40in,width=4.85in,viewport=0 0 145 80,clip]{Figures/Gray-KG_Chem-entity-overview.png}
...
\begin{figure}[h!]
\centering
%\includegraphics[height=2.40in,width=4.85in,viewport=0 0 145 85,clip]{Figures/Gray-KG_Chem-entity-overview-hyperlink.png}
...
\begin{figure}[h!]
\centering
\includegraphics[height=2.40in,width=4.85in,viewport=0 0 145 80,clip]{Figures/KG_Chem-neo4j.png}
\caption{\small\textrm{知识图谱智能\textrm{neo4j}搜索示例}}%(与文献\cite{EPJB33-47_2003}图1对比)
...
\begin{figure}[h!]
\centering
%\includegraphics[height=3.40in,width=4.85in,viewport=0 0 145 110,clip]{Figures/Gray-KG_Chem-visualization.png}
...
本研究任务分别得到科技创新 2030 重大项目" 基于人工智能技术的高性能多尺度分子动力学模拟平台"(2024ZD0606900)%国家重点专项" 高通量并发式材料计算算法和软件"(2017YFB0701500) 
