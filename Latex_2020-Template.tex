...
%\addcontentsline{toc}{section}{\CJKfamily{hei} 目录/CONTENTS}  %如果需要将目录页插入目录
...
%\phantomsection\addcontentsline{toc}{section}{参考文献}    %目录中表示为“参考文献”
...
\bibliography{/home/jun-jiang/Documents/Reference/Myref} %% 接近ieeert样式
