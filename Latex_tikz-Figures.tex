...
\begin{tikzpicture}[
  ...
  \node [box-rect, right=0.9 of Figure, fill=gray!30, text width=12.5em, minimum height=0.5em] (Highthrough-Put) {\fontsize{7.5pt}{5.5pt}\selectfont{\textrm{Python/Web High~throughput Service}}};
  \node [box-rect, right=1.0 of Highthrough-Put, fill=white, text width=3.5em, minimum height=14.0em, yshift=-3.5em, very thin] (Modeling-Initial) {\fontsize{7.5pt}{2.5pt}\selectfont{Modeling and Initialization\vskip 0.4pt}};
  \node [box-rect, below=0.5 of Figure, fill=red!30, text width=7.5em, minimum height=0.5em] (Modeling-mode) {\fontsize{7.5pt}{5.5pt}\selectfont{Modeling\\\textrm{+ASE\_Atoms}}};
  \node [box-rect, right=1.0 of Modeling-mode, fill=red!30, text width=4.5em, minimum height=0.5em] (User-defineded) {\fontsize{7.5pt}{5.5pt}\selectfont{User defined}};
  \node [box-rect, right=1.0 of User-defineded, fill=brown!30, text width=4.5em, minimum height=0.5em] (Process-Design) {\fontsize{7.5pt}{5.5pt}\selectfont{Process Design}};
  \node [box-rect, below=0.5 of Modeling-mode, fill=green!30, text width=10.5em, minimum height=0.5em] (Modeling-Analysis) {\fontsize{7.5pt}{5.5pt}\selectfont{Analysis of content and symmetry}};

  \node [box-rect, below=1.5 of Modeling-Analysis, fill=blue!50, text width=6.5em, minimum height=0.5em, xshift=3.5em] (Process-Manage) {\fontsize{7.5pt}{2.5pt}\selectfont{\textrm{MP\_FireWorks}}};
  \node [box-rect, right=1.95 of Process-Manage, fill=red!50, text width=9.0em, minimum height=6.0em] (Multi-Scale) {\fontsize{7.5pt}{5.5pt}\selectfont{\vskip -25ptHighthroughput Calculation\\\textrm{DFT-MD-$\cdots$}\\\textrm{(Multi-scale)}}};
  \node [box-rect, right=2.1 of Process-Manage, fill=orange!50, text width=8.2em, minimum height=0.5em, yshift=-1.8em] (Custodian) {\fontsize{7.5pt}{5.5pt}\selectfont{\textrm{Cudodian}}};
  \node [box-rect, below=0.05 of Modeling-Initial, fill=white, text width=3.5em, minimum height=10.3em, very thin] (Multi-Scale-Simulation) {\fontsize{7.5pt}{2.5pt}\selectfont{Multi-scale Simulation\vskip 0.4pt}};
  \node [below=1.0 of Process-Manage, text width=9.5em, minimum height=0.5em] (DataBase) {\fontsize{7.5pt}{5.5pt}\selectfont{\textcolor{violet}{\textrm{Database~(MongoDB)}}}};

  \node [box-rect, below=0.8 of DataBase, fill=olive!60, text width=12.5em, minimum height=2.5em] (Data-Manage) {\fontsize{7.5pt}{5.5pt}\selectfont{Data:~Analysis and Management}};
  \node [box-rect, below=0.8 of Data-Manage, fill=lime!70, text width=6.5em, minimum height=1.5em, xshift=-3.5em] (Result-Analysis) {\fontsize{7.5pt}{5.5pt}\selectfont{Result-Analysis}};
  \node [box-rect, right=0.5 of Result-Analysis, fill=teal!70, text width=15.5em, minimum height=1.5em] (Machine-Learning) {\fontsize{7.5pt}{5.5pt}\selectfont{\textrm{Python}ML algorithm integrated:~\textrm{GPR/BO/ANN}}};
  \node [box-rect, below=2.5 of Data-Manage, fill=darkgray!70, text width=15.5em, minimum height=1.5em, xshift=5.0em] (Application) {\fontsize{7.5pt}{5.5pt}\selectfont{\textcolor{white}{Application:\\Multi-body interaction between atoms}}};
  \node [box-rect, below=0.05 of Multi-Scale-Simulation, fill=white, text width=3.5em, minimum height=11.0em, very thin] (Result-Machine-Learning) {\fontsize{7.5pt}{2.5pt}\selectfont{Result-Machine-Learing\vskip 0.4pt }};
...
\end{tikzpicture}
%\caption{\tiny \textrm{Pseudopotential for metallic sodium, based on the empty core model and screened by the Thomas-Fermi dielectric function.}}%(与文献\cite{EPJB33-47_2003}图1对比)
\label{Fig:BCC-Multi-Procedure-En}
\end{figure}
...
\end{tikzpicture}
%\caption{\tiny \textrm{Pseudopotential for metallic sodium, based on the empty core model and screened by the Thomas-Fermi dielectric function.}}%(与文献\cite{EPJB33-47_2003}图1对比)
\label{Fig:BCC-Multi-Procedure-Ch}
\end{figure}
...
\begin{tikzpicture}[
  ...
  \node [box-rect, fill=green!40, text width=3.0em, minimum height=1.5em, yshift=-3.5em, very thin] (Modeling-Initial) {\fontsize{7.5pt}{2.5pt}\selectfont{Modeling}};
  \node [box-rect, right=1.0 of Modeling-Initial, fill=blue!30, text width=4.5em, minimum height=0.5em] (Highthrough-DFT) {\fontsize{7.5pt}{5.5pt}\selectfont{\textrm{DFT}}};
  \node [box-rect, above=0.8 of Highthrough-DFT, fill=blue!30, text width=4.5em, minimum height=0.5em] (Highthrough-DFT1) {\fontsize{7.5pt}{5.5pt}\selectfont{\textrm{DFT}}};
  \node [box-rect, above=2.0 of Highthrough-DFT, fill=blue!30, text width=4.5em, minimum height=0.5em] (Highthrough-DFT2) {\fontsize{7.5pt}{5.5pt}\selectfont{\textrm{DFT}}};
  \node [box-rect, below=0.8 of Highthrough-DFT, fill=blue!30, text width=4.5em, minimum height=0.5em] (Highthrough-DFT3) {\fontsize{7.5pt}{5.5pt}\selectfont{\textrm{DFT}}};
  \node [box-rect, below=2.0 of Highthrough-DFT, fill=blue!30, text width=4.5em, minimum height=0.5em] (Highthrough-DFT4) {\fontsize{7.5pt}{5.5pt}\selectfont{\textrm{DFT}}};
  ...
  \node [box-rect, right=4.0 of Modeling-Initial, fill=cyan, text width=4.5em, minimum height=1.5em, very thin] (Modeling-Screen) {\fontsize{7.5pt}{2.5pt}\selectfont{Screen-Optimization}};
  \node [box-rect, right=1.4 of Modeling-Screen, fill=orange!40, text width=4.5em, minimum height=0.5em ] (Deter-Step) {\fontsize{7.5pt}{2.5pt}\selectfont{Speed-deter Step}};
  \node [box-rect, above=1.0 of Deter-Step, fill=orange!40, text width=4.5em, minimum height=0.5em] (Deter-Step1) {\fontsize{7.5pt}{2.5pt}\selectfont{Speed-deter Step}};
  \node [box-rect, below=1.0 of Deter-Step, fill=orange!40, text width=4.5em, minimum height=0.5em] (Deter-Step2) {\fontsize{7.5pt}{2.5pt}\selectfont{Speed-deter Step}};

  \node [box-rect, right=10.5 of Modeling-Initial, fill=darkgray!30, text width=2.5em, minimum height=1.5em, very thin] (Modeling-Coupling) {\fontsize{7.5pt}{2.5pt}\selectfont{Model-Coupling}};
  \node [above=1.0 of Modeling-Coupling, text width=7.0em, minimum height=0.5em] (Coupling) {\fontsize{7.5pt}{5.5pt}\selectfont{\textcolor{violet}{\textrm{DFT-MD Coupling}}}};
  \node [box-rect, right=12.0 of Modeling-Initial, fill=magenta!30, text width=4.5em, minimum height=0.5em] (MD-Calc) {\fontsize{7.5pt}{2.5pt}\selectfont{\textrm{MD \\Simulation}}};

\path
  (Deter-Step1.north) ++(-4.0 em, 0.6em) coordinate (Coupling1)
  (MD-Calc.south) ++(3.0 em, -6.0em) coordinate (Coupling2)
...
\node [rectangle,draw=violet, dashed, inner sep=0.8em,fit=(Coupling1) (Coupling2), line width=2.0pt] (enclosure) {};
  ...
  \path [arrow] (MD-Calc.east)--(Coupling-corner1)|-(Coupling-corner2) node[midway,below=0.50,outer sep=0pt, xshift=-10.0em](TextNode){\fontsize{7.0pt}{4.5pt}\selectfont{\textrm{\textcolor{black}{Optimization: Multi-iteration}}}}|-(Deter-Step.west) ;
\end{tikzpicture}
%\caption{\tiny \textrm{Pseudopotential for metallic sodium, based on the empty core model and screened by the Thomas-Fermi dielectric function.}}%(与文献\cite{EPJB33-47_2003}图1对比)
\label{Fig:BCC-Multi-Scale-Procedure-En}
\end{figure}
...
\end{tikzpicture}
%\caption{\tiny \textrm{Pseudopotential for metallic sodium, based on the empty core model and screened by the Thomas-Fermi dielectric function.}}%(与文献\cite{EPJB33-47_2003}图1对比)
\label{Fig:BCC-Multi-Scale-Procedure-Ch}
\end{figure}
