...
gnuplot.stdin .write(b"plot 'C-O_H-E_1' using 1:2 with p pointsize 0.5  linetype 8,")  
gnuplot.stdin .write(b" 'C-O_H-E_1' using 3:4 with p pointsize 0.5  linetype 7 \n")  
gnuplot.stdin .flush()
