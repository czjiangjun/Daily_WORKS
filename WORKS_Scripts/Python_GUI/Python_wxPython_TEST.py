...
#        sizer = wx.GridBagSizer(5, 5)
        ...
        if (self.cellgen.GetValue() and self.checkcell):
           ...
           self.sizer.Add(text_Cell, pos=(5, 0), flag=wx.LEFT|wx.TOP, border=10)
           self.text = text_Cell

           text_x_vector = wx.StaticText(self.panel, label="x_vector:")
           self.sizer.Add(text_x_vector, pos=(6, 0), flag=wx.LEFT|wx.TOP, border=5)
           self.x_vector = text_x_vector 

           tc_xx = wx.TextCtrl(self.panel)
           self.sizer.Add(tc_xx, pos=(6, 1), span=(1, 1), flag=wx.TOP|wx.LEFT,
                border=8)
           tc_xy = wx.TextCtrl(self.panel)
           self.sizer.Add(tc_xy, pos=(6, 2), span=(1, 1), flag=wx.TOP|wx.ALIGN_CENTER,
                border=8)
           tc_xz = wx.TextCtrl(self.panel)
           self.sizer.Add(tc_xz, pos=(6, 3), span=(1, 1), flag=wx.TOP|wx.RIGHT,
                border=8)

           text_y_vector = wx.StaticText(self.panel, label="y_vector:")
           self.sizer.Add(text_y_vector, pos=(7, 0), flag=wx.LEFT|wx.TOP, border=5)
           self.y_vector = text_y_vector 

           tc_yx = wx.TextCtrl(self.panel)
           self.sizer.Add(tc_yx, pos=(7, 1), span=(1, 1), flag=wx.TOP|wx.LEFT,
                border=8)
           tc_yy = wx.TextCtrl(self.panel)
           self.sizer.Add(tc_yy, pos=(7, 2), span=(1, 1), flag=wx.TOP|wx.ALIGN_CENTER,
                border=8)
           tc_yz = wx.TextCtrl(self.panel)
           self.sizer.Add(tc_yz, pos=(7, 3), span=(1, 1), flag=wx.TOP|wx.RIGHT,
                border=8)

           text_z_vector = wx.StaticText(self.panel, label="z_vector:")
           self.sizer.Add(text_z_vector, pos=(8, 0), flag=wx.LEFT|wx.TOP, border=5)
           self.z_vector = text_z_vector 

           tc_zx = wx.TextCtrl(self.panel)
           self.sizer.Add(tc_zx, pos=(8, 1), span=(1, 1), flag=wx.TOP|wx.LEFT,
                border=8)
           tc_zy = wx.TextCtrl(self.panel)
           self.sizer.Add(tc_zy, pos=(8, 2), span=(1, 1), flag=wx.TOP|wx.ALIGN_CENTER,
                border=8)
           tc_zz = wx.TextCtrl(self.panel)
           self.sizer.Add(tc_zz, pos=(8, 3), span=(1, 1), flag=wx.TOP|wx.RIGHT,
                border=8)
